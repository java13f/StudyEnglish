...
namespace StudyEnglish.Controller
{
    ...
    public interface IAllExpressionController
    {
        DataTable GetAllExpression();
    }

    public class MainController : OleDbHelper, IMainController, IAllExpressionController
    {
        ...
        #region IAllExpressionController
